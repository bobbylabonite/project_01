...
function preload() {
	invaderImg = loadImage("../media/images/ezgifcomputervirs.com-resize.gif");
	invader2Img = loadImage("../media/images/ezgifcomputervirs.com-resize.gif");
	spaceshipImg = loadImage("../media/images/galaga4.png");
	bulletImg = loadImage("../media/images/bullet4.png");
	bullet2Img = loadImage("../media/images/bullet3.png");
